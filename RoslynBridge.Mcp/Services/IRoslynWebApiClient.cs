...
public interface IRoslynWebApiClient
{
    ...
    Task<JsonDocument> SearchSymbolAsync(string symbolName, string? kind = null, string? projectName = null, bool excludeGenerated = true, CancellationToken ct = default);
    ...
    Task<JsonDocument> SearchCodeAsync(string pattern, string? scope = null, string? projectName = null, string? mode = null, string? solutionName = null, CancellationToken ct = default);
    ...
    Task<JsonDocument> FindCallersAsync(string symbolName, string? solutionName = null, CancellationToken ct = default);
